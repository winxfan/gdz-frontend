  ...
  return (
    <Box component="footer" sx={{ mt: 6, borderTop: '1px solid', borderColor: 'divider', py: 4 }}>
      <Box sx={{ px: { xs: 2, md: 4 }, mt: 3, color: 'text.secondary', display: 'grid', rowGap: 1.25 }}>
        ...
        <Typography variant="body2" sx={{ wordBreak: 'break-word' }}>ИП Резбаев Данил Эдуардович, ИНН 021904517407, ОГРНИП 325028002186815</Typography>
        <Typography variant="body2" sx={{ wordBreak: 'break-word' }}>Поддержка: <a href="mailto:hello@гдз-по-фото.рф">hello@гдз-по-фото.рф</a></Typography>
        <Box
          sx={{
            display: 'flex',
